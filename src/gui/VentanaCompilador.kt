...
class VentanaCompilador : JFrame(), ActionListener, KeyListener {
    ...
    var erroresSintacticos: JTable? = null
    private var scroll: JScrollPane? = null
    private var scrollArbol: JScrollPane? = null
    /**
    ...
    private var scrollErroresSintacticos: JScrollPane? = null
    private var scrollErroresSemanticos: JScrollPane? = null
    var arbolVisual: JTree? = null
    var mnEjecutar: JMenu? = null
    var mnArchivo: JMenu? = null
    var menuBarWindow: JMenuBar? = null
        private set
    var mntmAbrir: JMenuItem? = null
    var mntmEjecutar: JMenuItem? = null
    ...
    var erroresSemanticos: JTextArea? = null
    ...
    private fun init() {
        ...
        panelErroresSintacticos = JPanel(BorderLayout())
        panelErroresSintacticos!!.setBounds(0, 0, 1280, 720)
        panelErroresSintacticos!!.border = TitledBorder(null, "Errores sintacticos", TitledBorder.LEADING, TitledBorder.TOP, null, null)
        ...
        scrollArbol = JScrollPane(arbolVisual)
